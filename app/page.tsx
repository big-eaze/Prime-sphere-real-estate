...
export default async function HomePage() {
  ...
  return (
    <div className="w-full bg-[#EFEFEF] flex">
      <div className="w-full mb-30 flex flex-col gap-15 lg:gap-40 ml-0 lg:ml-86">
        {/* HERO */}
        <section className="relative w-full h-[500px] lg:h-[800px] overflow-hidden">
          <video
            autoPlay
            muted
            playsInline
          ...
          <div className="relative z-10 text-white flex flex-col gap-6 items-center justify-center h-full bg-black/50 px-4">
            <p className="text-sm lg:text-lg">Prime Sphere Real Estate</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            {[
              ...
              <div key={i} className="flex flex-col gap-2">
                ...
                <p className="text-gray-600 text-sm lg:text-lg">{item.second}</p>
              </div>
            ))}
          </div>
        ...
        <section className="flex flex-col lg:flex-row gap-10 w-full max-w-7xl mx-auto">
          <div className="relative w-full lg:w-1/2 h-80 lg:h-[500px]">
            <Image
              src="/my-team.jpg"
              alt="The team"
              fill
          ...
          <div className="flex-1 w-[90%] mx-auto text-gray-600 text-base lg:text-lg flex flex-col gap-4">
            <h1 className="text-2xl lg:text-3xl lg:text-5xl font-semibold text-black">
              Meet the Team
            </h1>
            <p>
            ...
            {[
              ...
              <div key={i} className="relative rounded-md overflow-hidden shadow-md group">
                <Image
                  ...
                  width={600}
                  height={400}
                  className="object-cover w-full h-64 sm:h-80 lg:h-[350px] transition-transform duration-500 group-hover:scale-110"
                />
